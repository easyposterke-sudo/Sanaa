...
Named speakers are now checked against their matching uploaded portrait. Their name should sit over the lower torso/hand-level area or immediately beside the lower body in restrained secondary type, rather than becoming a detached headline. Church/organization names and supplied logos are unbacked identity elements: generation forbids local cards, banners, rounded header strips, circles, or colour panels behind them, and preparation removes machine-detectable identity panels before rendering. Full-page artwork and logistics/theme cards are unaffected.
