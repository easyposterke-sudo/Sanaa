...
export function PosterPromptCreator({ onApply, onClose, onImport }: Props) {
  ...
  async function generate() {
    ...
    try {
      ...
      const families = portraits.length > 1 ? [8] : portraits.length ? [2, 4, 5, 8, 9, 10, 11, 12, 13, 14, 15, 16, 18] : [1, 3, 6, 7, 17];
